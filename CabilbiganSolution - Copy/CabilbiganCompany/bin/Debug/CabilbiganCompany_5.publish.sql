...
GO
PRINT N'Dropping Foreign Key [dbo].[FK_WORKS_Pno]...';


GO
ALTER TABLE [dbo].[WORKS_ON] DROP CONSTRAINT [FK_WORKS_Pno];


GO
PRINT N'Dropping Foreign Key [dbo].[FK_WORKS_Ssn]...';


GO
ALTER TABLE [dbo].[WORKS_ON] DROP CONSTRAINT [FK_WORKS_Ssn];


GO
PRINT N'Creating Foreign Key [dbo].[FK_WORKS_ON_Pno]...';


GO
ALTER TABLE [dbo].[WORKS_ON] WITH NOCHECK
    ADD CONSTRAINT [FK_WORKS_ON_Pno] FOREIGN KEY ([Pno]) REFERENCES [dbo].[PROJECT] ([Pnumber]);
...
GO
ALTER TABLE [dbo].[WORKS_ON] WITH CHECK CHECK CONSTRAINT [FK_WORKS_ON_Pno];

ALTER TABLE [dbo].[WORKS_ON] WITH CHECK CHECK CONSTRAINT [FK_WORKS_ON_Ssn];

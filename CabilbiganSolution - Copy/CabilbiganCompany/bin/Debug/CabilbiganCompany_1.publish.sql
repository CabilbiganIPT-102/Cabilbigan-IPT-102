...
GO
PRINT N'Dropping Foreign Key [dbo].[FX_Deparment_ssn]...';


GO
ALTER TABLE [dbo].[DEPARTMENT] DROP CONSTRAINT [FX_Deparment_ssn];


GO
PRINT N'Creating Foreign Key [dbo].[FK_Department_Mgr_ssn]...';


GO
ALTER TABLE [dbo].[DEPARTMENT] WITH NOCHECK
    ADD CONSTRAINT [FK_Department_Mgr_ssn] FOREIGN KEY ([Mgr_ssn]) REFERENCES [dbo].[EMPLOYEE] ([Ssn]);
...
GO
ALTER TABLE [dbo].[DEPARTMENT] WITH CHECK CHECK CONSTRAINT [FK_Department_Mgr_ssn];
